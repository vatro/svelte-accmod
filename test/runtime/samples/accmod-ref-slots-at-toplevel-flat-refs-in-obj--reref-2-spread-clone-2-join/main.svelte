<script>
	...
	onMount(() => {
		...
		const local_slot_refs_obj = { ...slot_refs1, ...slot_refs2 };
...
<Child bind:this={child}>
	<ChildSlot ind={0} bind:this={slot_refs1['cs0']} />
	<ChildSlot ind={1} bind:this={slot_refs1['cs1']} />
	<ChildSlot ind={2} bind:this={slot_refs2['cs2']} />
</Child>
